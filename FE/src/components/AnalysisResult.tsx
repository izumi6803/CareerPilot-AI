      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <div>
            ...
            <p className={`text-xl font-bold ${analysis.fitScore >= 80 ? 'text-green-600' : analysis.fitScore >= 60 ? 'text-yellow-600' : 'text-red-600'}`}>
              {analysis.fitScore}%
            </p>
          </div>
          <div>
      ...
      {analysis.companyContext && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
            <ListCard title="Online Presence" items={analysis.companyContext.onlinePresence} color="blue" compact />
            <ListCard title="Review Sentiment" items={analysis.companyContext.reviewSentiment} color="amber" compact />
            <ListCard title="Transparency Signals" items={analysis.companyContext.transparencySignals} color="green" compact />
            <ListCard title="Possible Concerns" items={analysis.companyContext.possibleConcerns} color="red" compact />
          </div>
          <p className="text-xs text-gray-400 italic">
            Disclaimer: These insights are generated by AI based on publicly available information and should not be considered definitive. Always do your own research before making career decisions. The final decision belongs to you.
          </p>
        </div>
      )}
